...
parser.add_argument('--nepochs', type=int, default=66)
...
def get_placa_loaders(data_aug=False, batch_size=128, test_batch_size=1000, perc=1.0):
    if data_aug:
    ...
    imagenet_data_train = datasets.ImageFolder('cropped/training/', transform=transform_train)
...
if __name__ == '__main__':
    ...
    fc_layers = [norm(64), nn.ReLU(inplace=True), nn.AdaptiveAvgPool2d((1, 1)), Flatten(), nn.Linear(64, 36)]
    ...
    train_loader, test_loader, train_eval_loader = get_placa_loaders(
